              ...
              GridView.count(
                ...
                children: [
                  ...
                  _StatCard(
                    ...
                    color: Colors.orange,
                    onTap: () => Navigator.pushNamed(context, '/governance/approvals'),
                  ),
                  _StatCard(
                    title: 'Total Collected',
                    value: currencyFormat.format(stats['total_contributions'] ?? 0),
                   ...
                   _StatCard(
                    ...
                    value: stats['pending_contributions_count']?.toString() ?? '-',
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: const Text('Approve or reject pending applications'),
                    ...
                    ListTile(
                      ...
                      subtitle: const Text('Create or update investment portfolios'),
                      trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                      onTap: () {}, // Navigate to investments management
                    ),
                    const Divider(),
                    ListTile(
